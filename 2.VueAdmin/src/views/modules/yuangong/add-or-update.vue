<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="员工账号" prop="yuangongzhanghao">
					<el-input v-model="ruleForm.yuangongzhanghao" placeholder="员工账号" clearable  :readonly="ro.yuangongzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="员工账号" prop="yuangongzhanghao">
