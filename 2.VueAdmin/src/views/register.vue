<template>
	<div>
		<div class="container" :style='{"minHeight":"auto","padding":"20px  20px 20px 400px","background-attachment":"fixed","background":"url(http://codegen.caihongy.cn/20240220/b7c1c0cd08d847ecb5e7145e3cdc43ae.jpg) no-repeat  center top / cover,#f9fbfd","display":"flex","width":"100%","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"40px 20px","margin":"0","borderRadius":"10px","flexWrap":"wrap","background":"rgba(106, 171, 156)","display":"flex","width":"450px"}' ref="rgsForm" class="rgs-form" :model="rgsForm" :rules="rules">
				<div v-if="true" :style='{"width":"100%","margin":"0 auto 20px auto","lineHeight":"44px","fontSize":"20px","color":"#fff","textAlign":"center"}' class="title">基于SSM的酒店管理系统注册</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 2px","height":"auto"}' class="list-item" v-if="tableName=='yuangong'">
					<div v-if="true" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#fff"}' class="lable" :class="changeRules('yuangongzhanghao')?'required':''">员工账号：</div>
					<el-input  v-model="ruleForm.yuangongzhanghao"  autocomplete="off" placeholder="员工账号"  type="text"  />
				</el-form-item>
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 2px","height":"auto"}' class="list-item" v-if="tableName=='yuangong'">
					<div v-if="true" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#fff"}' class="lable" :class="changeRules('mima')?'required':''">密码：</div>
					<el-input  v-model="ruleForm.mima"  autocomplete="off" placeholder="密码"  type="password"  />
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 2px","height":"auto"}' class="list-item" v-if="tableName=='yuangong'">
					<div v-if="true" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#fff"}' class="lable" :class="changeRules('yuangongxingming')?'required':''">员工姓名：</div>
				...
				<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 2px","height":"auto"}' class="list-item" v-if="tableName=='yuangong'">
					<div v-if="true" :style='{"width":"100%","lineHeight":"44px","fontSize":"14px","position":"relative","color":"#fff"}' class="lable" :class="changeRules('shenfenzhenghao')?'required':''">身份证号：</div>
