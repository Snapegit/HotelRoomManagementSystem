...
<div>
	...
	<div class="news-preview-pv" :style='{"width":"100%","padding":"0 10%","margin":"10px auto","position":"relative","background":"#F6F6F6"}'>
		...
		<div class="list4 index-pv1" :style='{"padding":"10px 0","margin":"10px 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
			...
			<div v-for="(item,index) in newsList" :key="item.id" v-if="index%4 == 0 || index%4 == 1" :style='{"width":"calc(50% - 20px)","padding":"0 0 10px","margin":"0 10px","borderRadius":"10px","background":"#fff","height":"auto"}' @click="toNewsDetail(item)" class="list-item animation-box">
			...
			<div v-for="(item,index) in newsList" :key="item.id" v-if="index%4 == 2 || index%4 == 3" :style='{"padding":"10px 20px","margin":"10px","borderRadius":"10px","background":"#fff","width":"calc(50% - 20px)","position":"relative","height":"auto"}' @click="toNewsDetail(item)" class="list-item animation-box">
