 ...
 */
public class FangjianxudingModel  implements Serializable {
	...
	public void setXudingtianshu(String xudingtianshu) {
	 ...
	 * 获取：续订天数
	 */
	public String getXudingtianshu() {
