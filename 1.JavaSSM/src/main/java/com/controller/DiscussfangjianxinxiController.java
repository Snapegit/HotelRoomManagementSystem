...
public class DiscussfangjianxinxiController {
    ...
    public R info(@PathVariable("id") Long id){
        ...
        discussfangjianxinxi = discussfangjianxinxiService.selectView(new EntityWrapper<DiscussfangjianxinxiEntity>().eq("id", id));
    ...
    public R security(@RequestParam String username){
        DiscussfangjianxinxiEntity discussfangjianxinxi = discussfangjianxinxiService.selectOne(new EntityWrapper<DiscussfangjianxinxiEntity>().eq("", username));
        return R.ok().put("data", discussfangjianxinxi);
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscussfangjianxinxiEntity discussfangjianxinxi, HttpServletRequest request,String pre){
        EntityWrapper<DiscussfangjianxinxiEntity> ew = new EntityWrapper<DiscussfangjianxinxiEntity>();
